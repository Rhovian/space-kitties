<template>
  <div class="roadmap-wrapper">
    <div class="roadmap-content-wrapper">
      <div class="roadmap">
        <div class="roadmap-title" data-aos="fade-up">Kitties Odyssey</div>
...
.cd-timeline-content::before {
  ...
  border-right: 7px solid #6b76a629;
}
